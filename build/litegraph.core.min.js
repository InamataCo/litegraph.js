...
(this.graph._last_trigger_time=g.getTime());for(var d=0;d<this.outputs.length;++d){var e=this.outputs[d];!e||e.type!==g.EVENT||a&&e.name!=a||this.triggerSlot(d,b,null,c)}}};l.prototype.triggerSlot=function(a,b,c,d){d=d||{};if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length){this.graph&&(this.graph._last_trigger_time=g.getTime());for(var e=0;e<a.length;++e){var f=a[e];if(null==c||c==f){var h=this.graph.links[a[e]];h&&(h._last_time=g.getTime(),f=this.graph.getNodeById(h.target_id))&&(f.mode===
g.ON_TRIGGER?(d.action_call||(d.action_call=this.id+"_trigg_"+Math.floor(9999*Math.random())),f.onExecute&&f.doExecute(b,d)):f.onAction&&(d.action_call||(d.action_call=this.id+"_act_"+Math.floor(9999*Math.random())),h=f.inputs[h.target_slot],f.actionDo(h.name,b,d)))}}}};l.prototype.clearTriggeredSlot=function(a,b){if(this.outputs&&(a=this.outputs[a])&&(a=a.links)&&a.length)for(var c=0;c<a.length;++c){var d=a[c];if(null==b||b==d)if(d=this.graph.links[a[c]])d._last_time=0}};l.prototype.setSize=function(a){this.size=
a;if(this.onResize)this.onResize(this.size)};l.prototype.addProperty=function(a,b,c,d){c={name:a,type:c,default_value:b};if(d)for(var e in d)c[e]=d[e];this.properties_info||(this.properties_info=[]);this.properties_info.push(c);this.properties||(this.properties={});this.properties[a]=b;return c};l.prototype.addOutput=function(a,b,c){a={name:a,type:b,links:null};if(c)for(var d in c)a[d]=c[d];this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);g.auto_load_slot_types&&
g.registerNodeAndSlotType(this,b,!0);this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0);return a};l.prototype.addOutputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],d={name:c[0],type:c[1],link:null};if(a[2])for(var e in c[2])d[e]=c[2][e];this.outputs||(this.outputs=[]);this.outputs.push(d);if(this.onOutputAdded)this.onOutputAdded(d);g.auto_load_slot_types&&g.registerNodeAndSlotType(this,c[1],!0)}this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0)};l.prototype.removeOutput=
...
t.value;if(c.type==g.pointerevents_method+"move"&&"number"==t.type)t.value+=.1*c.deltaX*(t.options.step||1),null!=t.options.min&&t.value<t.options.min&&(t.value=t.options.min),null!=t.options.max&&t.value>t.options.max&&(t.value=t.options.max);else if(c.type==g.pointerevents_method+"down"){var u=t.options.values;u&&u.constructor===Function&&(u=t.options.values(t,a));var r=null;"number"!=t.type&&(r=u.constructor===Array?u:Object.keys(u));f=40>f?-1:f>l-40?1:0;if("number"==t.type)t.value+=.1*f*(t.options.step||
1),null!=t.options.min&&t.value<t.options.min&&(t.value=t.options.min),null!=t.options.max&&t.value>t.options.max&&(t.value=t.options.max);else if(f)n=-1,this.last_mouseclick=0,n=u.constructor===Object?r.indexOf(String(t.value))+f:r.indexOf(t.value)+f,n>=r.length&&(n=r.length-1),0>n&&(n=0),t.value=u.constructor===Array?u[n]:n;else{var v=u!=r?Object.values(u):u;new g.ContextMenu(v,{scale:Math.max(1,this.ds.scale),event:c,className:"dark",callback:function(a,b,c){u!=r&&(a=v.indexOf(a));this.value=a;
e(this,a);p.dirty_canvas=!0;return!1}.bind(t)},n)}}else c.type==g.pointerevents_method+"up"&&"number"==t.type&&(f=40>f?-1:f>l-40?1:0,200>c.click_time&&0==f&&this.prompt("Value",t.value,function(a){this.value=Number(a);e(this,this.value)}.bind(t),c));d!=t.value&&setTimeout(function(){e(this,this.value)}.bind(t),20);this.dirty_canvas=!0;break;case "toggle":c.type==g.pointerevents_method+"down"&&(t.value=!t.value,setTimeout(function(){e(t,t.value)},20));break;case "string":case "text":c.type==g.pointerevents_method+
"down"&&this.prompt("Value",t.value,function(a){this.value=a;e(this,a)}.bind(t),c,t.options?t.options.multiline:!1);break;default:t.mouse&&(this.dirty_canvas=t.mouse(c,[f,h],a))}if(d!=t.value){if(a.onWidgetChanged)a.onWidgetChanged(t.name,t.value,d,t);a.graph._version++}return t}}}return null};m.prototype.drawGroups=function(a,b){if(this.graph){a=this.graph._groups;b.save();b.globalAlpha=.5*this.editor_alpha;for(var c=0;c<a.length;++c){var d=a[c];if(F(this.visible_area,d._bounding)){b.fillStyle=d.color||
...
value:c[k]});new g.ContextMenu(a,{event:b,callback:f,parentMenu:d,node:e});return!1}}if(e){var h=this;a=m.active_canvas.getCanvasWindow();b=e.optional_outputs;e.onGetOutputs&&(b=e.onGetOutputs());var k=[];if(b)for(var p=0;p<b.length;p++){var n=b[p];if(!n)k.push(null);else if(!e.flags||!e.flags.skip_repeated_outputs||-1==e.findOutputSlot(n[0])){var q=n[0];n[2]||(n[2]={});n[2].label&&(q=n[2].label);n[2].removable=!0;q={content:q,value:n};n[1]==g.EVENT&&(q.className="event");k.push(q)}}this.onMenuNodeOutputs&&
...
f=!1;d&&d.outputs&&d.outputs[a.origin_slot]&&(f=d.outputs[a.origin_slot].type);var h=!1;e&&e.outputs&&e.outputs[a.target_slot]&&(h=e.inputs[a.target_slot].type);var k=new g.ContextMenu(["Add Node",null,"Delete",null],{event:b,title:null!=a.data?a.data.constructor.name:null,callback:function(b,g,q){switch(b){case "Add Node":m.onMenuAdd(null,null,q,k,function(b){b.inputs&&b.inputs.length&&b.outputs&&b.outputs.length&&d.connectByType(a.origin_slot,b,f)&&(b.connectByType(a.target_slot,e,h),b.pos[0]-=
