...
k,this);this.processNodeDblClicked(f);q=!0}f.onMouseDown&&f.onMouseDown(a,k,this)?q=!0:(f.subgraph&&!f.skip_subgraph_button&&!f.flags.collapsed&&k[0]>f.size[0]-g.NODE_TITLE_HEIGHT&&0>k[1]&&(c=this,setTimeout(function(){c.openSubgraph(f.subgraph)},10)),this.live_mode&&(q=h=!0));q||(this.allow_dragnodes&&(this.graph.beforeChange(),this.node_dragged=f),this.processNodeSelected(f,a));this.dirty_canvas=!0}}else if(!d){if(!this.read_only)for(q=0;q<this.visible_links.length;++q)if(h=this.visible_links[q],
