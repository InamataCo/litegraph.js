...
f.NODE_WIDGET_HEIGHT,l=q.width||n;if(q==d||!(6>g||g>l-12||k<q.last_y||k>q.last_y+y||void 0===q.last_y)){d=q.value;switch(q.type){case "button":c.type===f.pointerevents_method+"down"&&(q.callback&&setTimeout(function(){q.callback(q,h,a,b,c)},20),this.dirty_canvas=q.clicked=!0);break;case "slider":d=q.value;r=Math.clamp((g-15)/(l-30),0,1);q.value=q.options.min+(q.options.max-q.options.min)*r;d!=q.value&&setTimeout(function(){e(q,q.value)},20);this.dirty_canvas=!0;break;case "number":case "combo":d=
