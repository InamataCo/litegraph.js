...
d.inputs.length)for(b=0;b<d.inputs.length;++b){var g=d.inputs[b];if(g&&null!=g.link&&(g=this.graph.links[g.link])){var k=this.graph.getNodeById(g.origin_id);k&&a.links.push([k._relative_id,g.origin_slot,d._relative_id,g.target_slot,k.id])}}}else console.warn("node type not found: "+d.type);localStorage.setItem("litegrapheditor_clipboard",JSON.stringify(a))};h.prototype.pasteFromClipboard=function(a){a=void 0===a?!1:a;var b=localStorage.getItem("litegrapheditor_clipboard");if(b){this.graph.beforeChange();
b=JSON.parse(b);for(var c=!1,e=!1,d=0;d<b.nodes.length;++d)c?(c[0]>b.nodes[d].pos[0]&&(c[0]=b.nodes[d].pos[0],e[0]=d),c[1]>b.nodes[d].pos[1]&&(c[1]=b.nodes[d].pos[1],e[1]=d)):(c=[b.nodes[d].pos[0],b.nodes[d].pos[1]],e=[d,d]);e=[];for(d=0;d<b.nodes.length;++d){var g=b.nodes[d],k=f.createNode(g.type);k&&(k.configure(g),k.pos[0]+=this.graph_mouse[0]-c[0],k.pos[1]+=this.graph_mouse[1]-c[1],this.graph.add(k,{doProcessChange:!1}),e.push(k))}for(d=0;d<b.links.length;++d){c=b.links[d];g=c[0];if(null!=g)var n=
e[g];else a&&(g=c[4])&&(n=this.graph.getNodeById(g));g=e[c[2]];n&&g?n.connect(c[1],g,c[3]):console.warn("Warning, nodes missing on pasting")}this.selectNodes(e);this.graph.afterChange()}};h.prototype.processDrop=function(a){a.preventDefault();this.adjustMouseEvent(a);var b=a.clientX,c=a.clientY;if(!this.viewport||this.viewport&&b>=this.viewport[0]&&b<this.viewport[0]+this.viewport[2]&&c>=this.viewport[1]&&c<this.viewport[1]+this.viewport[3]){b=[a.canvasX,a.canvasY];var e=this.graph?this.graph.getNodeOnPos(b[0],
b[1]):null;if(e){if((e.onDropFile||e.onDropData)&&(b=a.dataTransfer.files)&&b.length)for(c=0;c<b.length;c++){var d=a.dataTransfer.files[0],g=d.name;h.getFileExtension(g);if(e.onDropFile)e.onDropFile(d);if(e.onDropData){var k=new FileReader;k.onload=function(a){e.onDropData(a.target.result,g,d)};var f=d.type.split("/")[0];"text"==f||""==f?k.readAsText(d):"image"==f?k.readAsDataURL(d):k.readAsArrayBuffer(d)}}return e.onDropItem&&e.onDropItem(event)?!0:this.onDropItem?this.onDropItem(event):!1}b=null;
...
this.visible_nodes);for(var e=0;e<b.length;++e){var d=b[e];a.save();a.translate(d.pos[0],d.pos[1]);this.drawNode(d,a);a.restore()}this.render_execution_order&&this.drawExecutionOrder(a);this.graph.config.links_ontop&&(this.live_mode||this.drawConnections(a));if(null!=this.connecting_pos){a.lineWidth=this.connections_width;d=this.connecting_output||this.connecting_input;b=d.type;e=d.dir;null==e&&(e=this.connecting_output?this.connecting_node.horizontal?f.DOWN:f.RIGHT:this.connecting_node.horizontal?
f.UP:f.LEFT);var g=d.shape;switch(b){case f.EVENT:d=f.EVENT_LINK_COLOR;break;default:d=f.CONNECTING_LINK_COLOR}this.renderLink(a,this.connecting_pos,[this.graph_mouse[0],this.graph_mouse[1]],null,!1,null,d,e,f.CENTER);a.beginPath();b===f.EVENT||g===f.BOX_SHAPE?(a.rect(this.connecting_pos[0]-6+.5,this.connecting_pos[1]-5+.5,14,10),a.fill(),a.beginPath(),a.rect(this.graph_mouse[0]-6+.5,this.graph_mouse[1]-5+.5,14,10)):g===f.ARROW_SHAPE?(a.moveTo(this.connecting_pos[0]+8,this.connecting_pos[1]+.5),a.lineTo(this.connecting_pos[0]-
...
if(this.onDrawOverlay)this.onDrawOverlay(a);c&&a.restore();a.finish2D&&a.finish2D()}};h.prototype.drawSubgraphPanel=function(a){var b=this.graph,c=b._subgraph_node;c?(this.drawSubgraphPanelLeft(b,c,a),this.drawSubgraphPanelRight(b,c,a)):console.warn("subgraph without subnode")};h.prototype.drawSubgraphPanelLeft=function(a,b,c){var e=b.inputs?b.inputs.length:0,d=Math.floor(1.6*f.NODE_SLOT_HEIGHT);c.fillStyle="#111";c.globalAlpha=.8;c.beginPath();c.roundRect(10,10,200,(e+1)*d+50,[8]);c.fill();c.globalAlpha=
...
this.node_dragged=p,this.dragging_canvas=!1,p.setProperty("name",k.name),p.setProperty("type",k.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",n)}c.fillStyle="#9C9";c.beginPath();c.arc(184,e+.5*d,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(k.name,30,e+.75*d);c.fillStyle="#777";c.fillText(k.type,130,e+.75*d);e+=d}}this.drawButton(20,e+2,180,d-2,"+","#151515","#222")&&
this.showSubgraphPropertiesDialog(b)}};h.prototype.drawSubgraphPanelRight=function(a,b,c){var e=b.outputs?b.outputs.length:0,d=this.bgcanvas.width,g=Math.floor(1.6*f.NODE_SLOT_HEIGHT);c.fillStyle="#111";c.globalAlpha=.8;c.beginPath();c.roundRect(d-200-10,10,200,(e+1)*g+50,[8]);c.fill();c.globalAlpha=1;c.fillStyle="#888";c.font="14px Arial";c.textAlign="left";e=c.measureText("Graph Outputs").width;c.fillText("Graph Outputs",d-e-20,34);if(this.drawButton(d-200,20,20,20,"X","#151515"))this.closeSubgraph();
...
this,this.canvas)}else{var g=this.editor_alpha;b.globalAlpha=g;this.render_shadows&&!d?(b.shadowColor=f.DEFAULT_SHADOW_COLOR,b.shadowOffsetX=2*this.ds.scale,b.shadowOffsetY=2*this.ds.scale,b.shadowBlur=3*this.ds.scale):b.shadowColor="transparent";if(!a.flags.collapsed||!a.onDrawCollapsed||1!=a.onDrawCollapsed(b,this)){var k=a._shape||f.BOX_SHAPE;H.set(a.size);var n=a.horizontal;if(a.flags.collapsed){b.font=this.inner_text_font;var p=a.getTitle?a.getTitle():a.title;null!=p&&(a._collapsed_width=Math.min(a.size[0],
b.measureText(p).width+2*f.NODE_TITLE_HEIGHT),H[0]=a._collapsed_width,H[1]=0)}a.clip_area&&(b.save(),b.beginPath(),k==f.BOX_SHAPE?b.rect(0,0,H[0],H[1]):k==f.ROUND_SHAPE?b.roundRect(0,0,H[0],H[1],[10]):k==f.CIRCLE_SHAPE&&b.arc(.5*H[0],.5*H[1],.5*H[0],0,2*Math.PI),b.clip());a.has_errors&&(e="red");this.drawNodeShape(a,b,H,c,e,a.is_selected,a.mouseOver);b.shadowColor="transparent";if(a.onDrawForeground)a.onDrawForeground(b,this,this.canvas);b.textAlign=n?"center":"left";b.font=this.inner_text_font;e=
!d;var r=this.connecting_output;k=this.connecting_input;b.lineWidth=1;p=0;var u=new Float32Array(2);if(!a.flags.collapsed){if(a.inputs)for(c=0;c<a.inputs.length;c++){var q=a.inputs[c],y=q.type,h=q.shape;b.globalAlpha=g;this.connecting_output&&!f.isValidConnection(q.type,r.type)&&(b.globalAlpha=.4*g);b.fillStyle=null!=q.link?q.color_on||this.default_connection_color_byType[y]||this.default_connection_color.input_on:q.color_off||this.default_connection_color_byTypeOff[y]||this.default_connection_color_byType[y]||
this.default_connection_color.input_off;var v=a.getConnectionPos(!0,c,u);v[0]-=a.pos[0];v[1]-=a.pos[1];p<v[1]+.5*f.NODE_SLOT_HEIGHT&&(p=v[1]+.5*f.NODE_SLOT_HEIGHT);b.beginPath();"array"==y&&(h=f.GRID_SHAPE);q.type===f.EVENT||q.shape===f.BOX_SHAPE?n?b.rect(v[0]-5+.5,v[1]-8+.5,10,14):b.rect(v[0]-6+.5,v[1]-5+.5,14,10):h===f.ARROW_SHAPE?(b.moveTo(v[0]+8,v[1]+.5),b.lineTo(v[0]-4,v[1]+6+.5),b.lineTo(v[0]-4,v[1]-6+.5),b.closePath()):h===f.GRID_SHAPE?(b.rect(v[0]-4,v[1]-4,2,2),b.rect(v[0]-1,v[1]-4,2,2),b.rect(v[0]+
2,v[1]-4,2,2),b.rect(v[0]-4,v[1]-1,2,2),b.rect(v[0]-1,v[1]-1,2,2),b.rect(v[0]+2,v[1]-1,2,2),b.rect(v[0]-4,v[1]+2,2,2),b.rect(v[0]-1,v[1]+2,2,2),b.rect(v[0]+2,v[1]+2,2,2)):d?b.rect(v[0]-4,v[1]-4,8,8):b.arc(v[0],v[1],4,0,2*Math.PI);b.fill();e&&(y=null!=q.label?q.label:q.name)&&(b.fillStyle=f.NODE_TEXT_COLOR,n||q.dir==f.UP?b.fillText(y,v[0],v[1]-10):b.fillText(y,v[0]+10,v[1]+5))}b.textAlign=n?"center":"right";b.strokeStyle="black";if(a.outputs)for(c=0;c<a.outputs.length;c++)if(q=a.outputs[c],y=q.type,
h=q.shape,this.connecting_input&&!f.isValidConnection(y,k.type)&&(b.globalAlpha=.4*g),v=a.getConnectionPos(!1,c,u),v[0]-=a.pos[0],v[1]-=a.pos[1],p<v[1]+.5*f.NODE_SLOT_HEIGHT&&(p=v[1]+.5*f.NODE_SLOT_HEIGHT),b.fillStyle=q.links&&q.links.length?q.color_on||this.default_connection_color_byType[y]||this.default_connection_color.output_on:q.color_off||this.default_connection_color_byTypeOff[y]||this.default_connection_color_byType[y]||this.default_connection_color.output_off,b.beginPath(),"array"==y&&(h=
f.GRID_SHAPE),r=!0,y===f.EVENT||h===f.BOX_SHAPE?n?b.rect(v[0]-5+.5,v[1]-8+.5,10,14):b.rect(v[0]-6+.5,v[1]-5+.5,14,10):h===f.ARROW_SHAPE?(b.moveTo(v[0]+8,v[1]+.5),b.lineTo(v[0]-4,v[1]+6+.5),b.lineTo(v[0]-4,v[1]-6+.5),b.closePath()):h===f.GRID_SHAPE?(b.rect(v[0]-4,v[1]-4,2,2),b.rect(v[0]-1,v[1]-4,2,2),b.rect(v[0]+2,v[1]-4,2,2),b.rect(v[0]-4,v[1]-1,2,2),b.rect(v[0]-1,v[1]-1,2,2),b.rect(v[0]+2,v[1]-1,2,2),b.rect(v[0]-4,v[1]+2,2,2),b.rect(v[0]-1,v[1]+2,2,2),b.rect(v[0]+2,v[1]+2,2,2),r=!1):d?b.rect(v[0]-
4,v[1]-4,8,8):b.arc(v[0],v[1],4,0,2*Math.PI),b.fill(),!d&&r&&b.stroke(),e&&(y=null!=q.label?q.label:q.name))b.fillStyle=f.NODE_TEXT_COLOR,n||q.dir==f.DOWN?b.fillText(y,v[0],v[1]-8):b.fillText(y,v[0]-10,v[1]+5);b.textAlign="left";b.globalAlpha=1;if(a.widgets){q=p;if(n||a.widgets_up)q=2;null!=a.widgets_start_y&&(q=a.widgets_start_y);this.drawNodeWidgets(a,q,b,this.node_widget&&this.node_widget[0]==a?this.node_widget[1]:null)}}else if(this.render_collapsed_slots){d=g=null;if(a.inputs)for(c=0;c<a.inputs.length;c++)if(q=
a.inputs[c],null!=q.link){g=q;break}if(a.outputs)for(c=0;c<a.outputs.length;c++)q=a.outputs[c],q.links&&q.links.length&&(d=q);g&&(g=0,c=-.5*f.NODE_TITLE_HEIGHT,n&&(g=.5*a._collapsed_width,c=-f.NODE_TITLE_HEIGHT),b.fillStyle="#686",b.beginPath(),q.type===f.EVENT||q.shape===f.BOX_SHAPE?b.rect(g-7+.5,c-4,14,8):q.shape===f.ARROW_SHAPE?(b.moveTo(g+8,c),b.lineTo(g+-4,c-4),b.lineTo(g+-4,c+4),b.closePath()):b.arc(g,c,4,0,2*Math.PI),b.fill());d&&(g=a._collapsed_width,c=-.5*f.NODE_TITLE_HEIGHT,n&&(g=.5*a._collapsed_width,
...
2,-k+2,k-4,k-4,[4]),b.fill()),b.fillStyle="#333",b.beginPath(),b.moveTo(u+.2*k,.6*-k),b.lineTo(u+.8*k,.6*-k),b.lineTo(u+.5*k,.3*-k),b.fill());if(a.onDrawTitle)a.onDrawTitle(b)}if(g){if(a.onBounding)a.onBounding(C);r==f.TRANSPARENT_TITLE&&(C[1]-=d,C[3]+=d);b.lineWidth=1;b.globalAlpha=.8;b.beginPath();p==f.BOX_SHAPE?b.rect(-6+C[0],-6+C[1],12+C[2],12+C[3]):p==f.ROUND_SHAPE||p==f.CARD_SHAPE&&a.flags.collapsed?b.roundRect(-6+C[0],-6+C[1],12+C[2],12+C[3],[2*this.round_radius]):p==f.CARD_SHAPE?b.roundRect(-6+
C[0],-6+C[1],12+C[2],12+C[3],[2*this.round_radius,2,2*this.round_radius,2]):p==f.CIRCLE_SHAPE&&b.arc(.5*c[0],.5*c[1],.5*c[0]+6,0,2*Math.PI);b.strokeStyle=f.NODE_BOX_OUTLINE_COLOR;b.stroke();b.strokeStyle=e;b.globalAlpha=1}0<a.execute_triggered&&a.execute_triggered--;0<a.action_triggered&&a.action_triggered--};var L=new Float32Array(4),G=new Float32Array(4),K=new Float32Array(2),J=new Float32Array(2);h.prototype.drawConnections=function(a){var b=f.getTime(),c=this.visible_area;L[0]=c[0]-20;L[1]=c[1]-
20;L[2]=c[2]+40;L[3]=c[3]+40;a.lineWidth=this.connections_width;a.fillStyle="#AAA";a.strokeStyle="#AAA";a.globalAlpha=this.editor_alpha;c=this.graph._nodes;for(var e=0,d=c.length;e<d;++e){var g=c[e];if(g.inputs&&g.inputs.length)for(var k=0;k<g.inputs.length;++k){var n=g.inputs[k];if(n&&null!=n.link&&(n=this.graph.links[n.link])){var p=this.graph.getNodeById(n.origin_id);if(null!=p){var r=n.origin_slot;var u=-1==r?[p.pos[0]+10,p.pos[1]+10]:p.getConnectionPos(!1,r,K);var q=g.getConnectionPos(!0,k,J);
G[0]=u[0];G[1]=u[1];G[2]=q[0]-u[0];G[3]=q[1]-u[1];0>G[2]&&(G[0]+=G[2],G[2]=Math.abs(G[2]));0>G[3]&&(G[1]+=G[3],G[3]=Math.abs(G[3]));if(B(G,L)){var y=p.outputs[r];r=g.inputs[k];if(y&&r&&(p=y.dir||(p.horizontal?f.DOWN:f.RIGHT),r=r.dir||(g.horizontal?f.UP:f.LEFT),this.renderLink(a,u,q,n,!1,0,null,p,r),n&&n._last_time&&1E3>b-n._last_time)){y=2-.002*(b-n._last_time);var h=a.globalAlpha;a.globalAlpha=h*y;this.renderLink(a,u,q,n,!0,y,"white",p,r);a.globalAlpha=h}}}}}}a.globalAlpha=1};h.prototype.renderLink=
function(a,b,c,e,d,g,k,n,p,r){e&&this.visible_links.push(e);!k&&e&&(k=e.color||h.link_type_colors[e.type]);k||(k=this.default_link_color);null!=e&&this.highlighted_links[e.id]&&(k="#FFF");n=n||f.RIGHT;p=p||f.LEFT;var u=E(b,c);this.render_connections_border&&.6<this.ds.scale&&(a.lineWidth=this.connections_width+4);a.lineJoin="round";r=r||1;1<r&&(a.lineWidth=.5);a.beginPath();for(var q=0;q<r;q+=1){var y=5*(q-.5*(r-1));if(this.links_render_mode==f.SPLINE_LINK){a.moveTo(b[0],b[1]+y);var l=0,v=0,m=0,w=
...
function(a,b,c,e,d){e=e||f.RIGHT;d=d||f.LEFT;var g=E(a,b),k=[a[0],a[1]],n=[b[0],b[1]];switch(e){case f.LEFT:k[0]+=-.25*g;break;case f.RIGHT:k[0]+=.25*g;break;case f.UP:k[1]+=-.25*g;break;case f.DOWN:k[1]+=.25*g}switch(d){case f.LEFT:n[0]+=-.25*g;break;case f.RIGHT:n[0]+=.25*g;break;case f.UP:n[1]+=-.25*g;break;case f.DOWN:n[1]+=.25*g}e=(1-c)*(1-c)*(1-c);d=3*(1-c)*(1-c)*c;g=3*(1-c)*c*c;c*=c*c;return[e*a[0]+d*k[0]+g*n[0]+c*b[0],e*a[1]+d*k[1]+g*n[1]+c*b[1]]};h.prototype.drawExecutionOrder=function(a){a.shadowColor=
...
d(this,a);h.dirty_canvas=!0;return!1}.bind(q)},r)}}else c.type==f.pointerevents_method+"up"&&"number"==q.type&&(g=40>g?-1:g>l-40?1:0,200>c.click_time&&0==g&&this.prompt("Value",q.value,function(a){if(/^[0-9+\-*/()\s]+$/.test(a))try{a=eval(a)}catch(O){}this.value=Number(a);d(this,this.value)}.bind(q),c));e!=q.value&&setTimeout(function(){d(this,this.value)}.bind(q),20);this.dirty_canvas=!0;break;case "toggle":c.type==f.pointerevents_method+"down"&&(q.value=!q.value,setTimeout(function(){d(q,q.value)},
20));break;case "string":case "text":c.type==f.pointerevents_method+"down"&&this.prompt("Value",q.value,function(a){d(this,a)}.bind(q),c,q.options?q.options.multiline:!1);break;default:q.mouse&&(this.dirty_canvas=q.mouse(c,[g,k],a))}if(e!=q.value){if(a.onWidgetChanged)a.onWidgetChanged(q.name,q.value,e,q);a.graph._version++}return q}}}return null};h.prototype.drawGroups=function(a,b){if(this.graph){a=this.graph._groups;b.save();b.globalAlpha=.5*this.editor_alpha;for(var c=0;c<a.length;++c){var e=
...
0;c<a.inputs.length;++c){var g=a.inputs[c];if(!g.not_subgraph_input){var k=e.addHTML("<button>&#10005;</button> <span class='bullet_icon'></span><span class='name'></span><span class='type'></span>","subgraph_property");k.dataset.name=g.name;k.dataset.slot=c;k.querySelector(".name").innerText=g.name;k.querySelector(".type").innerText=g.type;k.querySelector("button").addEventListener("click",function(c){a.removeInput(Number(this.parentNode.dataset.slot));b()})}}}console.log("showing subgraph properties dialog");
