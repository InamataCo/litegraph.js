...
b.type=a;f.debug&&console.log("Node registered: "+a);var c=b.name,e=a.lastIndexOf("/");b.category=a.substring(0,e);b.title||(b.title=c);if(b.prototype)for(var d in l.prototype)b.prototype[d]||(b.prototype[d]=l.prototype[d]);if(e=this.registered_node_types[a])console.log("replacing node type: "+a);else if(Object.prototype.hasOwnProperty.call(b.prototype,"shape")||Object.defineProperty(b.prototype,"shape",{set:function(a){switch(a){case "default":delete this._shape;break;case "box":this._shape=f.BOX_SHAPE;
break;case "round":this._shape=f.ROUND_SHAPE;break;case "circle":this._shape=f.CIRCLE_SHAPE;break;case "card":this._shape=f.CARD_SHAPE;break;default:this._shape=a}},get:function(){return this._shape},enumerable:!0,configurable:!0}),b.prototype.onPropertyChange&&console.warn("LiteGraph node class "+a+" has onPropertyChange method, it must be called onPropertyChanged with d at the end"),b.supported_extensions)for(var g in b.supported_extensions)(d=b.supported_extensions[g])&&d.constructor===String&&
...
b="string"==typeof b?b.split(","):b==this.EVENT||b==this.ACTION?["_event_"]:["*"];for(var e=0;e<b.length;++e){var d=b[e];""===d&&(d="*");var g=c?"registered_slot_out_types":"registered_slot_in_types";"undefined"==typeof this[g][d]&&(this[g][d]={nodes:[]});this[g][d].nodes.push(a);c?this.slot_types_out.includes(d.toLowerCase())||(this.slot_types_out.push(d.toLowerCase()),this.slot_types_out.sort()):this.slot_types_in.includes(d.toLowerCase())||(this.slot_types_in.push(d.toLowerCase()),this.slot_types_in.sort())}},
wrapFunctionAsNode:function(a,b,c,e,d){for(var g=Array(b.length),k="",n=f.getParameterNames(b),p=0;p<n.length;++p)k+="this.addInput('"+n[p]+"',"+(c&&c[p]?"'"+c[p]+"'":"0")+");\n";k+="this.addOutput('out',"+(e?"'"+e+"'":0)+");\n";d&&(k+="this.properties = "+JSON.stringify(d)+";\n");c=Function(k);c.title=a.split("/").pop();c.desc="Generated from "+b.name;c.prototype.onExecute=function(){for(var a=0;a<g.length;++a)g[a]=this.getInputData(a);a=b.apply(this,g);this.setOutputData(0,a)};this.registerNodeType(a,
...
null;if(f.catch_exceptions)try{d=new e(b)}catch(k){return console.error(k),null}else d=new e(b);d.type=a;!d.title&&b&&(d.title=b);d.properties||(d.properties={});d.properties_info||(d.properties_info=[]);d.flags||(d.flags={});d.size||(d.size=d.computeSize());d.pos||(d.pos=f.DEFAULT_POSITION.concat());d.mode||(d.mode=f.ALWAYS);if(c)for(var g in c)d[g]=c[g];if(d.onNodeCreated)d.onNodeCreated();return d},getNodeType:function(a){return this.registered_node_types[a]},getNodeTypesInCategory:function(a,
...
n;c=c.sort(function(a,b){var c=a.constructor.priority||a.priority||0,d=b.constructor.priority||b.priority||0;return c==d?a.order-b.order:c-d});for(n=0;n<p;++n)c[n].order=n;return c};m.prototype.getAncestors=function(a){for(var b=[],c=[a],e={};c.length;){var d=c.shift();if(d.inputs){e[d.id]||d==a||(e[d.id]=!0,b.push(d));for(var g=0;g<d.inputs.length;++g){var k=d.getInputNode(g);k&&-1==b.indexOf(k)&&c.push(k)}}}b.sort(function(a,b){return a.order-b.order});return b};m.prototype.arrange=function(a,b){a=
a||100;for(var c=this.computeExecutionOrder(!1,!0),e=[],d=0;d<c.length;++d){var g=c[d],k=g._level||1;e[k]||(e[k]=[]);e[k].push(g)}c=a;for(d=0;d<e.length;++d)if(g=e[d]){k=100;for(var n=a+f.NODE_TITLE_HEIGHT,p=0;p<g.length;++p){var r=g[p];r.pos[0]=b==f.VERTICAL_LAYOUT?n:c;r.pos[1]=b==f.VERTICAL_LAYOUT?c:n;var u=b==f.VERTICAL_LAYOUT?1:0;r.size[u]>k&&(k=r.size[u]);n+=r.size[b==f.VERTICAL_LAYOUT?0:1]+a+f.NODE_TITLE_HEIGHT}c+=k+a}this.setDirtyCanvas(!0,!0)};m.prototype.getTime=function(){return this.globaltime};
m.prototype.getFixedTime=function(){return this.fixedtime};m.prototype.getElapsedTime=function(){return this.elapsed_time};m.prototype.sendEventToAllNodes=function(a,b,c){c=c||f.ALWAYS;var e=this._nodes_in_order?this._nodes_in_order:this._nodes;if(e)for(var d=0,g=e.length;d<g;++d){var k=e[d];if(k.constructor===f.Subgraph&&"onExecute"!=a)k.mode==c&&k.sendEventToAllNodes(a,b,c);else if(k[a]&&k.mode==c)if(void 0===b)k[a]();else if(b&&b.constructor===Array)k[a].apply(k,b);else k[a](b)}};m.prototype.sendActionToCanvas=
...
function(a,b,c){a={name:a,type:b,links:null};if(c)for(var e in c)a[e]=c[e];this.outputs||(this.outputs=[]);this.outputs.push(a);if(this.onOutputAdded)this.onOutputAdded(a);f.auto_load_slot_types&&f.registerNodeAndSlotType(this,b,!0);this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0);return a};l.prototype.addOutputs=function(a){for(var b=0;b<a.length;++b){var c=a[b],e={name:c[0],type:c[1],link:null};if(a[2])for(var d in c[2])e[d]=c[2][d];this.outputs||(this.outputs=[]);this.outputs.push(e);
if(this.onOutputAdded)this.onOutputAdded(e);f.auto_load_slot_types&&f.registerNodeAndSlotType(this,c[1],!0)}this.setSize(this.computeSize());this.setDirtyCanvas(!0,!0)};l.prototype.removeOutput=function(a){this.disconnectOutput(a);this.outputs.splice(a,1);for(var b=a;b<this.outputs.length;++b)if(this.outputs[b]&&this.outputs[b].links)for(var c=this.outputs[b].links,e=0;e<c.length;++e){var d=this.graph.links[c[e]];d&&--d.origin_slot}this.setSize(this.computeSize());if(this.onOutputRemoved)this.onOutputRemoved(a);
...
function(a,b,c,e){a={name:a,type:b,pos:c,direction:e,links:null};this.connections.push(a);return a};l.prototype.computeSize=function(a){function b(a){return a?e*a.length*.6:0}if(this.constructor.size)return this.constructor.size.concat();var c=Math.max(this.inputs?this.inputs.length:1,this.outputs?this.outputs.length:1);a=a||new Float32Array([0,0]);c=Math.max(c,1);var e=f.NODE_TEXT_SIZE,d=b(this.title),g=0,k=0;if(this.inputs)for(var n=0,p=this.inputs.length;n<p;++n){var r=this.inputs[n];r=r.label||
...
if(""==b||"*"==b)b=0;for(var g=0,k=a.length;g<k;++g){var n=(b+"").toLowerCase().split(","),p="0"==a[g].type||"*"==a[g].type?"0":a[g].type;p=(p+"").toLowerCase().split(",");for(sI=0;sI<n.length;sI++)for(dI=0;dI<p.length;dI++)if("_event_"==n[sI]&&(n[sI]=f.EVENT),"_event_"==p[sI]&&(p[sI]=f.EVENT),"*"==n[sI]&&(n[sI]=0),"*"==p[sI]&&(p[sI]=0),!(n[sI]!=p[dI]||e&&a[g].links&&null!==a[g].links))return c?a[g]:g}if(e&&!d)for(g=0,k=a.length;g<k;++g)for(n=(b+"").toLowerCase().split(","),p="0"==a[g].type||"*"==
...
e);b&&b.constructor===Number&&(b=this.graph.getNodeById(b));d=b.findOutputSlotByType(c,!1,!0);if(0<=d&&null!==d)return b.connect(d,this,a);if(e.generalTypeInCase){var d=b.findOutputSlotByType(0,!1,!0,!0);if(0<=d)return b.connect(d,this,a)}if(e.createEventInCase&&c==f.EVENT&&f.do_add_triggers_slots)return d=b.addOnExecutedOutput(),b.connect(d,this,a);if(e.firstFreeIfInputGeneralInCase&&(0==c||"*"==c||""==c)&&(d=b.findOutputSlotFree({typesNotAccepted:[f.EVENT]}),0<=d))return b.connect(d,this,a);console.debug("no way to connect byOUT type: ",
...
a),!1}else if(!this.inputs||a>=this.inputs.length)return f.debug&&console.log("Connect: Error, slot number not found"),!1;var b=this.inputs[a];if(!b)return!1;var c=this.inputs[a].link;if(null!=c){this.inputs[a].link=null;var e=this.graph.links[c];if(e){var d=this.graph.getNodeById(e.origin_id);if(!d)return!1;var g=d.outputs[e.origin_slot];if(!g||!g.links||0==g.links.length)return!1;for(var k=0,n=g.links.length;k<n;k++)if(g.links[k]==c){g.links.splice(k,1);break}delete this.graph.links[c];this.graph&&
...
this._bounding;return{title:this.title,bounding:[Math.round(a[0]),Math.round(a[1]),Math.round(a[2]),Math.round(a[3])],color:this.color,font:this.font}};w.prototype.move=function(a,b,c){this._pos[0]+=a;this._pos[1]+=b;if(!c)for(c=0;c<this._nodes.length;++c){var e=this._nodes[c];e.pos[0]+=a;e.pos[1]+=b}};w.prototype.recomputeInsideNodes=function(){this._nodes.length=0;for(var a=this.graph._nodes,b=new Float32Array(4),c=0;c<a.length;++c){var e=a[c];e.getBounding(b);B(this._bounding,b)&&this._nodes.push(e)}};
