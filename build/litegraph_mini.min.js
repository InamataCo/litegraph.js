...
null);var g=document.createElement("div");g.className="litegraph litecontextmenu litemenubar-panel";b.className&&(g.className+=" "+b.className);g.style.minWidth=100;g.style.minHeight=100;g.style.pointerEvents="none";setTimeout(function(){g.style.pointerEvents="auto"},100);f.pointerListenerAdd(g,"up",function(a){a.preventDefault();return!0},!0);g.addEventListener("contextmenu",function(a){if(2!=a.button)return!1;a.preventDefault();return!1},!0);f.pointerListenerAdd(g,"down",function(a){if(2==a.button)return e.close(),
...
function(){this._nodes_in_order=this.computeExecutionOrder(!1);this._nodes_executable=[];for(var a=0;a<this._nodes_in_order.length;++a)this._nodes_in_order[a].onExecute&&this._nodes_executable.push(this._nodes_in_order[a])};m.prototype.computeExecutionOrder=function(a,b){for(var c=[],e=[],d={},g={},k={},n=0,p=this._nodes.length;n<p;++n){var r=this._nodes[n];if(!a||r.onExecute){d[r.id]=r;var u=0;if(r.inputs)for(var q=0,y=r.inputs.length;q<y;q++)r.inputs[q]&&null!=r.inputs[q].link&&(u+=1);0==u?(e.push(r),
b&&(r._level=1)):(b&&(r._level=0),k[r.id]=u)}}for(;0!=e.length;)if(r=e.shift(),c.push(r),delete d[r.id],r.outputs)for(n=0;n<r.outputs.length;n++)if(a=r.outputs[n],null!=a&&null!=a.links&&0!=a.links.length)for(q=0;q<a.links.length;q++)(p=this.links[a.links[q]])&&!g[p.id]&&(u=this.getNodeById(p.target_id),null==u?g[p.id]=!0:(b&&(!u._level||u._level<=r._level)&&(u._level=r._level+1),g[p.id]=!0,--k[u.id],0==k[u.id]&&e.push(u)));for(n in d)c.push(d[n]);c.length!=this._nodes.length&&f.debug&&console.warn("something went wrong, nodes missing");
...
m.prototype.arrange=function(a,b){a=a||100;for(var c=this.computeExecutionOrder(!1,!0),e=[],d=0;d<c.length;++d){var g=c[d],k=g._level||1;e[k]||(e[k]=[]);e[k].push(g)}c=a;for(d=0;d<e.length;++d)if(g=e[d]){k=100;for(var n=a+f.NODE_TITLE_HEIGHT,p=0;p<g.length;++p){var r=g[p];r.pos[0]=b==f.VERTICAL_LAYOUT?n:c;r.pos[1]=b==f.VERTICAL_LAYOUT?c:n;var u=b==f.VERTICAL_LAYOUT?1:0;r.size[u]>k&&(k=r.size[u]);n+=r.size[b==f.VERTICAL_LAYOUT?0:1]+a+f.NODE_TITLE_HEIGHT}c+=k+a}this.setDirtyCanvas(!0,!0)};m.prototype.getTime=
...
d.inputs.length)for(b=0;b<d.inputs.length;++b){var g=d.inputs[b];if(g&&null!=g.link&&(g=this.graph.links[g.link])){var k=this.graph.getNodeById(g.origin_id);k&&this.selected_nodes[k.id]&&a.links.push([k._relative_id,g.origin_slot,d._relative_id,g.target_slot])}}}else console.warn("node type not found: "+d.type);localStorage.setItem("litegrapheditor_clipboard",JSON.stringify(a))};h.prototype.pasteFromClipboard=function(){var a=localStorage.getItem("litegrapheditor_clipboard");if(a){this.graph.beforeChange();
a=JSON.parse(a);for(var b=!1,c=!1,e=0;e<a.nodes.length;++e)b?(b[0]>a.nodes[e].pos[0]&&(b[0]=a.nodes[e].pos[0],c[0]=e),b[1]>a.nodes[e].pos[1]&&(b[1]=a.nodes[e].pos[1],c[1]=e)):(b=[a.nodes[e].pos[0],a.nodes[e].pos[1]],c=[e,e]);c=[];for(e=0;e<a.nodes.length;++e){var d=a.nodes[e],g=f.createNode(d.type);g&&(g.configure(d),g.pos[0]+=this.graph_mouse[0]-b[0],g.pos[1]+=this.graph_mouse[1]-b[1],this.graph.add(g,{doProcessChange:!1}),c.push(g))}for(e=0;e<a.links.length;++e)b=a.links[e],d=c[b[0]],g=c[b[2]],
d&&g?d.connect(b[1],g,b[3]):console.warn("Warning, nodes missing on pasting");this.selectNodes(c);this.graph.afterChange()}};h.prototype.processDrop=function(a){a.preventDefault();this.adjustMouseEvent(a);var b=a.clientX,c=a.clientY;if(!this.viewport||this.viewport&&b>=this.viewport[0]&&b<this.viewport[0]+this.viewport[2]&&c>=this.viewport[1]&&c<this.viewport[1]+this.viewport[3]){b=[a.canvasX,a.canvasY];var e=this.graph?this.graph.getNodeOnPos(b[0],b[1]):null;if(e){if((e.onDropFile||e.onDropData)&&
(b=a.dataTransfer.files)&&b.length)for(c=0;c<b.length;c++){var d=a.dataTransfer.files[0],g=d.name;h.getFileExtension(g);if(e.onDropFile)e.onDropFile(d);if(e.onDropData){var k=new FileReader;k.onload=function(a){e.onDropData(a.target.result,g,d)};var f=d.type.split("/")[0];"text"==f||""==f?k.readAsText(d):"image"==f?k.readAsDataURL(d):k.readAsArrayBuffer(d)}}return e.onDropItem&&e.onDropItem(event)?!0:this.onDropItem?this.onDropItem(event):!1}b=null;this.onDropItem&&(b=this.onDropItem(event));b||this.checkDropItem(a)}};
...
if(a.inputs)for(var b=0;b<a.inputs.length;++b)delete this.highlighted_links[a.inputs[b].link];if(a.outputs)for(b=0;b<a.outputs.length;++b){var c=a.outputs[b];if(c.links)for(var e=0;e<c.links.length;++e)delete this.highlighted_links[c.links[e]]}}};h.prototype.deselectAllNodes=function(){if(this.graph){for(var a=this.graph._nodes,b=0,c=a.length;b<c;++b){var e=a[b];if(e.is_selected){if(e.onDeselected)e.onDeselected();e.is_selected=!1;if(this.onNodeDeselected)this.onNodeDeselected(e)}}this.selected_nodes=
...
b[e];a.save();a.translate(d.pos[0],d.pos[1]);this.drawNode(d,a);a.restore()}this.render_execution_order&&this.drawExecutionOrder(a);this.graph.config.links_ontop&&(this.live_mode||this.drawConnections(a));if(null!=this.connecting_pos){a.lineWidth=this.connections_width;d=this.connecting_output||this.connecting_input;b=d.type;e=d.dir;null==e&&(e=this.connecting_output?this.connecting_node.horizontal?f.DOWN:f.RIGHT:this.connecting_node.horizontal?f.UP:f.LEFT);var g=d.shape;switch(b){case f.EVENT:d=
f.EVENT_LINK_COLOR;break;default:d=f.CONNECTING_LINK_COLOR}this.renderLink(a,this.connecting_pos,[this.graph_mouse[0],this.graph_mouse[1]],null,!1,null,d,e,f.CENTER);a.beginPath();b===f.EVENT||g===f.BOX_SHAPE?(a.rect(this.connecting_pos[0]-6+.5,this.connecting_pos[1]-5+.5,14,10),a.fill(),a.beginPath(),a.rect(this.graph_mouse[0]-6+.5,this.graph_mouse[1]-5+.5,14,10)):g===f.ARROW_SHAPE?(a.moveTo(this.connecting_pos[0]+8,this.connecting_pos[1]+.5),a.lineTo(this.connecting_pos[0]-4,this.connecting_pos[1]+
6+.5),a.lineTo(this.connecting_pos[0]-4,this.connecting_pos[1]-6+.5),a.closePath()):(a.arc(this.connecting_pos[0],this.connecting_pos[1],4,0,2*Math.PI),a.fill(),a.beginPath(),a.arc(this.graph_mouse[0],this.graph_mouse[1],4,0,2*Math.PI));a.fill();a.fillStyle="#ffcc00";if(this._highlight_input){a.beginPath();var k=this._highlight_input_slot.shape;k===f.ARROW_SHAPE?(a.moveTo(this._highlight_input[0]+8,this._highlight_input[1]+.5),a.lineTo(this._highlight_input[0]-4,this._highlight_input[1]+6+.5),a.lineTo(this._highlight_input[0]-
4,this._highlight_input[1]-6+.5),a.closePath()):a.arc(this._highlight_input[0],this._highlight_input[1],6,0,2*Math.PI);a.fill()}this._highlight_output&&(a.beginPath(),k===f.ARROW_SHAPE?(a.moveTo(this._highlight_output[0]+8,this._highlight_output[1]+.5),a.lineTo(this._highlight_output[0]-4,this._highlight_output[1]+6+.5),a.lineTo(this._highlight_output[0]-4,this._highlight_output[1]-6+.5),a.closePath()):a.arc(this._highlight_output[0],this._highlight_output[1],6,0,2*Math.PI),a.fill())}this.dragging_rectangle&&
...
a.restore();a.finish2D&&a.finish2D()}};h.prototype.drawSubgraphPanel=function(a){var b=this.graph,c=b._subgraph_node;c?(this.drawSubgraphPanelLeft(b,c,a),this.drawSubgraphPanelRight(b,c,a)):console.warn("subgraph without subnode")};h.prototype.drawSubgraphPanelLeft=function(a,b,c){var e=b.inputs?b.inputs.length:0,d=Math.floor(1.6*f.NODE_SLOT_HEIGHT);c.fillStyle="#111";c.globalAlpha=.8;c.beginPath();c.roundRect(10,10,200,(e+1)*d+50,[8]);c.fill();c.globalAlpha=1;c.fillStyle="#888";c.font="14px Arial";
...
!1,p.setProperty("name",k.name),p.setProperty("type",k.type),this.node_dragged.pos[0]=this.graph_mouse[0]-5,this.node_dragged.pos[1]=this.graph_mouse[1]-5,this.graph.afterChange()):console.error("graph input node not found:",n)}c.fillStyle="#9C9";c.beginPath();c.arc(184,e+.5*d,5,0,2*Math.PI);c.fill();c.fillStyle="#AAA";c.fillText(k.name,30,e+.75*d);c.fillStyle="#777";c.fillText(k.type,130,e+.75*d);e+=d}}this.drawButton(20,e+2,180,d-2,"+","#151515","#222")&&this.showSubgraphPropertiesDialog(b)}};h.prototype.drawSubgraphPanelRight=
...
1!=a.onDrawCollapsed(b,this)){var k=a._shape||f.BOX_SHAPE;H.set(a.size);var n=a.horizontal;if(a.flags.collapsed){b.font=this.inner_text_font;var p=a.getTitle?a.getTitle():a.title;null!=p&&(a._collapsed_width=Math.min(a.size[0],b.measureText(p).width+2*f.NODE_TITLE_HEIGHT),H[0]=a._collapsed_width,H[1]=0)}a.clip_area&&(b.save(),b.beginPath(),k==f.BOX_SHAPE?b.rect(0,0,H[0],H[1]):k==f.ROUND_SHAPE?b.roundRect(0,0,H[0],H[1],[10]):k==f.CIRCLE_SHAPE&&b.arc(.5*H[0],.5*H[1],.5*H[0],0,2*Math.PI),b.clip());a.has_errors&&
...
.4*g);b.fillStyle=null!=q.link?q.color_on||this.default_connection_color_byType[y]||this.default_connection_color.input_on:q.color_off||this.default_connection_color_byTypeOff[y]||this.default_connection_color_byType[y]||this.default_connection_color.input_off;var v=a.getConnectionPos(!0,c,u);v[0]-=a.pos[0];v[1]-=a.pos[1];p<v[1]+.5*f.NODE_SLOT_HEIGHT&&(p=v[1]+.5*f.NODE_SLOT_HEIGHT);b.beginPath();"array"==y&&(h=f.GRID_SHAPE);q.type===f.EVENT||q.shape===f.BOX_SHAPE?n?b.rect(v[0]-5+.5,v[1]-8+.5,10,14):
b.rect(v[0]-6+.5,v[1]-5+.5,14,10):h===f.ARROW_SHAPE?(b.moveTo(v[0]+8,v[1]+.5),b.lineTo(v[0]-4,v[1]+6+.5),b.lineTo(v[0]-4,v[1]-6+.5),b.closePath()):h===f.GRID_SHAPE?(b.rect(v[0]-4,v[1]-4,2,2),b.rect(v[0]-1,v[1]-4,2,2),b.rect(v[0]+2,v[1]-4,2,2),b.rect(v[0]-4,v[1]-1,2,2),b.rect(v[0]-1,v[1]-1,2,2),b.rect(v[0]+2,v[1]-1,2,2),b.rect(v[0]-4,v[1]+2,2,2),b.rect(v[0]-1,v[1]+2,2,2),b.rect(v[0]+2,v[1]+2,2,2)):d?b.rect(v[0]-4,v[1]-4,8,8):b.arc(v[0],v[1],4,0,2*Math.PI);b.fill();e&&(y=null!=q.label?q.label:q.name)&&
(b.fillStyle=f.NODE_TEXT_COLOR,n||q.dir==f.UP?b.fillText(y,v[0],v[1]-10):b.fillText(y,v[0]+10,v[1]+5))}b.textAlign=n?"center":"right";b.strokeStyle="black";if(a.outputs)for(c=0;c<a.outputs.length;c++)if(q=a.outputs[c],y=q.type,h=q.shape,this.connecting_input&&!f.isValidConnection(y,k.type)&&(b.globalAlpha=.4*g),v=a.getConnectionPos(!1,c,u),v[0]-=a.pos[0],v[1]-=a.pos[1],p<v[1]+.5*f.NODE_SLOT_HEIGHT&&(p=v[1]+.5*f.NODE_SLOT_HEIGHT),b.fillStyle=q.links&&q.links.length?q.color_on||this.default_connection_color_byType[y]||
this.default_connection_color.output_on:q.color_off||this.default_connection_color_byTypeOff[y]||this.default_connection_color_byType[y]||this.default_connection_color.output_off,b.beginPath(),"array"==y&&(h=f.GRID_SHAPE),r=!0,y===f.EVENT||h===f.BOX_SHAPE?n?b.rect(v[0]-5+.5,v[1]-8+.5,10,14):b.rect(v[0]-6+.5,v[1]-5+.5,14,10):h===f.ARROW_SHAPE?(b.moveTo(v[0]+8,v[1]+.5),b.lineTo(v[0]-4,v[1]+6+.5),b.lineTo(v[0]-4,v[1]-6+.5),b.closePath()):h===f.GRID_SHAPE?(b.rect(v[0]-4,v[1]-4,2,2),b.rect(v[0]-1,v[1]-
4,2,2),b.rect(v[0]+2,v[1]-4,2,2),b.rect(v[0]-4,v[1]-1,2,2),b.rect(v[0]-1,v[1]-1,2,2),b.rect(v[0]+2,v[1]-1,2,2),b.rect(v[0]-4,v[1]+2,2,2),b.rect(v[0]-1,v[1]+2,2,2),b.rect(v[0]+2,v[1]+2,2,2),r=!1):d?b.rect(v[0]-4,v[1]-4,8,8):b.arc(v[0],v[1],4,0,2*Math.PI),b.fill(),!d&&r&&b.stroke(),e&&(y=null!=q.label?q.label:q.name))b.fillStyle=f.NODE_TEXT_COLOR,n||q.dir==f.DOWN?b.fillText(y,v[0],v[1]-8):b.fillText(y,v[0]-10,v[1]+5);b.textAlign="left";b.globalAlpha=1;if(a.widgets){q=p;if(n||a.widgets_up)q=2;null!=
a.widgets_start_y&&(q=a.widgets_start_y);this.drawNodeWidgets(a,q,b,this.node_widget&&this.node_widget[0]==a?this.node_widget[1]:null)}}else if(this.render_collapsed_slots){d=g=null;if(a.inputs)for(c=0;c<a.inputs.length;c++)if(q=a.inputs[c],null!=q.link){g=q;break}if(a.outputs)for(c=0;c<a.outputs.length;c++)q=a.outputs[c],q.links&&q.links.length&&(d=q);g&&(g=0,c=-.5*f.NODE_TITLE_HEIGHT,n&&(g=.5*a._collapsed_width,c=-f.NODE_TITLE_HEIGHT),b.fillStyle="#686",b.beginPath(),q.type===f.EVENT||q.shape===
...
(k=f.NODE_TITLE_HEIGHT,u=a.size[0]-k,q=f.isInsideRectangle(this.graph_mouse[0]-a.pos[0],this.graph_mouse[1]-a.pos[1],u+2,-k+2,k-4,k-4),b.fillStyle=q?"#888":"#555",p==f.BOX_SHAPE||n?b.fillRect(u+2,-k+2,k-4,k-4):(b.beginPath(),b.roundRect(u+2,-k+2,k-4,k-4,[4]),b.fill()),b.fillStyle="#333",b.beginPath(),b.moveTo(u+.2*k,.6*-k),b.lineTo(u+.8*k,.6*-k),b.lineTo(u+.5*k,.3*-k),b.fill());if(a.onDrawTitle)a.onDrawTitle(b)}if(g){if(a.onBounding)a.onBounding(C);r==f.TRANSPARENT_TITLE&&(C[1]-=d,C[3]+=d);b.lineWidth=
...
g.inputs[k];if(n&&null!=n.link&&(n=this.graph.links[n.link])){var p=this.graph.getNodeById(n.origin_id);if(null!=p){var r=n.origin_slot;var u=-1==r?[p.pos[0]+10,p.pos[1]+10]:p.getConnectionPos(!1,r,K);var q=g.getConnectionPos(!0,k,J);G[0]=u[0];G[1]=u[1];G[2]=q[0]-u[0];G[3]=q[1]-u[1];0>G[2]&&(G[0]+=G[2],G[2]=Math.abs(G[2]));0>G[3]&&(G[1]+=G[3],G[3]=Math.abs(G[3]));if(B(G,L)){var y=p.outputs[r];r=g.inputs[k];if(y&&r&&(p=y.dir||(p.horizontal?f.DOWN:f.RIGHT),r=r.dir||(g.horizontal?f.UP:f.LEFT),this.renderLink(a,
u,q,n,!1,0,null,p,r),n&&n._last_time&&1E3>b-n._last_time)){y=2-.002*(b-n._last_time);var h=a.globalAlpha;a.globalAlpha=h*y;this.renderLink(a,u,q,n,!0,y,"white",p,r);a.globalAlpha=h}}}}}}a.globalAlpha=1};h.prototype.renderLink=function(a,b,c,e,d,g,k,n,p,r){e&&this.visible_links.push(e);!k&&e&&(k=e.color||h.link_type_colors[e.type]);k||(k=this.default_link_color);null!=e&&this.highlighted_links[e.id]&&(k="#FFF");n=n||f.RIGHT;p=p||f.LEFT;var u=E(b,c);this.render_connections_border&&.6<this.ds.scale&&
...
n?c.roundRect(15,v,l-30,k,[.5*k]):c.rect(15,v,l-30,k);c.fill();n&&!h.disabled&&c.stroke();c.fillStyle=h.value?"#89A":"#333";c.beginPath();c.arc(l-30,v+.5*k,.36*k,0,2*Math.PI);c.fill();n&&(c.fillStyle=q,null!=h.name&&c.fillText(h.name,30,v+.7*k),c.fillStyle=h.value?u:q,c.textAlign="right",c.fillText(h.value?h.options.on||"true":h.options.off||"false",l-40,v+.7*k));break;case "slider":c.fillStyle=r;c.fillRect(15,v,l-30,k);var m=h.options.max-h.options.min,w=(h.value-h.options.min)/m;c.fillStyle=e==
h?"#89A":"#678";c.fillRect(15,v,w*(l-30),k);n&&!h.disabled&&c.strokeRect(15,v,l-30,k);h.marker&&(m=(h.marker-h.options.min)/m,c.fillStyle="#AA9",c.fillRect(15+m*(l-30),v,2,k));n&&(c.textAlign="center",c.fillStyle=u,c.fillText(h.name+"  "+Number(h.value).toFixed(3),.5*l,v+.7*k));break;case "number":case "combo":c.textAlign="left";c.strokeStyle=p;c.fillStyle=r;c.beginPath();n?c.roundRect(15,v,l-30,k,[.5*k]):c.rect(15,v,l-30,k);c.fill();n&&(h.disabled||c.stroke(),c.fillStyle=u,h.disabled||(c.beginPath(),
c.moveTo(31,v+5),c.lineTo(21,v+.5*k),c.lineTo(31,v+k-5),c.fill(),c.beginPath(),c.moveTo(l-15-16,v+5),c.lineTo(l-15-6,v+.5*k),c.lineTo(l-15-16,v+k-5),c.fill()),c.fillStyle=q,c.fillText(h.name,35,v+.7*k),c.fillStyle=u,c.textAlign="right","number"==h.type?c.fillText(Number(h.value).toFixed(void 0!==h.options.precision?h.options.precision:3),l-30-20,v+.7*k):(m=h.value,h.options.values&&(w=h.options.values,w.constructor===Function&&(w=w()),w&&w.constructor!==Array&&(m=w[h.value])),c.fillText(m,l-30-20,
v+.7*k)));break;case "string":case "text":c.textAlign="left";c.strokeStyle=p;c.fillStyle=r;c.beginPath();n?c.roundRect(15,v,l-30,k,[.5*k]):c.rect(15,v,l-30,k);c.fill();n&&(h.disabled||c.stroke(),c.save(),c.beginPath(),c.rect(15,v,l-30,k),c.clip(),c.fillStyle=q,null!=h.name&&c.fillText(h.name,30,v+.7*k),c.fillStyle=u,c.textAlign="right",c.fillText(String(h.value).substr(0,30),l-30,v+.7*k),c.restore());break;default:h.draw&&h.draw(c,a,l,v,k)}b+=(h.computeSize?h.computeSize(l)[1]:k)+4;c.globalAlpha=
this.editor_alpha}c.restore();c.textAlign="left"};h.prototype.processNodeWidgets=function(a,b,c,e){function d(d,e){d.value=e;d.options&&d.options.property&&void 0!==a.properties[d.options.property]&&a.setProperty(d.options.property,e);d.callback&&d.callback(d.value,h,a,b,c)}if(!a.widgets||!a.widgets.length)return null;for(var g=b[0]-a.pos[0],k=b[1]-a.pos[1],n=a.size[0],h=this,r=this.getCanvasWindow(),u=0;u<a.widgets.length;++u){var q=a.widgets[u];if(q&&!q.disabled){var y=q.computeSize?q.computeSize(n)[1]:
f.NODE_WIDGET_HEIGHT,l=q.width||n;if(q==e||!(6>g||g>l-12||k<q.last_y||k>q.last_y+y||void 0===q.last_y)){e=q.value;switch(q.type){case "button":c.type===f.pointerevents_method+"down"&&(q.callback&&setTimeout(function(){q.callback(q,h,a,b,c)},20),this.dirty_canvas=q.clicked=!0);break;case "slider":e=q.value;r=Math.clamp((g-15)/(l-30),0,1);q.value=q.options.min+(q.options.max-q.options.min)*r;e!=q.value&&setTimeout(function(){d(q,q.value)},20);this.dirty_canvas=!0;break;case "number":case "combo":e=
q.value;if(c.type==f.pointerevents_method+"move"&&"number"==q.type)c.deltaX&&(q.value+=.1*c.deltaX*(q.options.step||1)),null!=q.options.min&&q.value<q.options.min&&(q.value=q.options.min),null!=q.options.max&&q.value>q.options.max&&(q.value=q.options.max);else if(c.type==f.pointerevents_method+"down"){var v=q.options.values;v&&v.constructor===Function&&(v=q.options.values(q,a));var m=null;"number"!=q.type&&(m=v.constructor===Array?v:Object.keys(v));g=40>g?-1:g>l-40?1:0;if("number"==q.type)q.value+=
.1*g*(q.options.step||1),null!=q.options.min&&q.value<q.options.min&&(q.value=q.options.min),null!=q.options.max&&q.value>q.options.max&&(q.value=q.options.max);else if(g)r=-1,this.last_mouseclick=0,r=v.constructor===Object?m.indexOf(String(q.value))+g:m.indexOf(q.value)+g,r>=m.length&&(r=m.length-1),0>r&&(r=0),q.value=v.constructor===Array?v[r]:r;else{var w=v!=m?Object.values(v):v;new f.ContextMenu(w,{scale:Math.max(1,this.ds.scale),event:c,className:"dark",callback:function(a,b,c){v!=m&&(a=w.indexOf(a));
this.value=a;d(this,a);h.dirty_canvas=!0;return!1}.bind(q)},r)}}else c.type==f.pointerevents_method+"up"&&"number"==q.type&&(g=40>g?-1:g>l-40?1:0,200>c.click_time&&0==g&&this.prompt("Value",q.value,function(a){this.value=Number(a);d(this,this.value)}.bind(q),c));e!=q.value&&setTimeout(function(){d(this,this.value)}.bind(q),20);this.dirty_canvas=!0;break;case "toggle":c.type==f.pointerevents_method+"down"&&(q.value=!q.value,setTimeout(function(){d(q,q.value)},20));break;case "string":case "text":c.type==
f.pointerevents_method+"down"&&this.prompt("Value",q.value,function(a){this.value=a;d(this,a)}.bind(q),c,q.options?q.options.multiline:!1);break;default:q.mouse&&(this.dirty_canvas=q.mouse(c,[g,k],a))}if(e!=q.value){if(a.onWidgetChanged)a.onWidgetChanged(q.name,q.value,e,q);a.graph._version++}return q}}}return null};h.prototype.drawGroups=function(a,b){if(this.graph){a=this.graph._groups;b.save();b.globalAlpha=.5*this.editor_alpha;for(var c=0;c<a.length;++c){var e=a[c];if(B(this.visible_area,e._bounding)){b.fillStyle=
e.color||"#335";b.strokeStyle=e.color||"#335";var d=e._pos,g=e._size;b.globalAlpha=.25*this.editor_alpha;b.beginPath();b.rect(d[0]+.5,d[1]+.5,g[0],g[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(d[0]+g[0],d[1]+g[1]);b.lineTo(d[0]+g[0]-10,d[1]+g[1]);b.lineTo(d[0]+g[0],d[1]+g[1]-10);b.fill();g=e.font_size||f.DEFAULT_GROUP_FONT_SIZE;b.font=g+"px Arial";b.textAlign="left";b.fillText(e.title,d[0]+4,d[1]+g)}}b.restore()}};h.prototype.adjustNodesSize=function(){for(var a=
...
!0);d.graph.afterChange()}else{a=[];for(var r in c)a.push({content:r,value:c[r]});new f.ContextMenu(a,{event:b,callback:g,parentMenu:e,node:d});return!1}}if(d){var k=this;a=h.active_canvas.getCanvasWindow();b=d.optional_outputs;d.onGetOutputs&&(b=d.onGetOutputs());var n=[];if(b)for(var p=0;p<b.length;p++){var r=b[p];if(!r)n.push(null);else if(!d.flags||!d.flags.skip_repeated_outputs||-1==d.findOutputSlot(r[0])){var u=r[0];r[2]||(r[2]={});r[2].label&&(u=r[2].label);r[2].removable=!0;u={content:u,value:r};
r[1]==f.EVENT&&(u.className="event");n.push(u)}}this.onMenuNodeOutputs&&(n=this.onMenuNodeOutputs(n));f.do_add_triggers_slots&&-1==d.findOutputSlot("onExecuted")&&n.push({content:"On Executed",value:["onExecuted",f.EVENT,{nameLocked:!0}],className:"event"});d.onMenuNodeOutputs&&(b=d.onMenuNodeOutputs(n))&&(n=b);if(n.length)return new f.ContextMenu(n,{event:c,callback:g,parentMenu:e,node:d},a),!1}};h.onShowMenuNodeProperties=function(a,b,c,e,d){if(d&&d.properties){var g=h.active_canvas;b=g.getCanvasWindow();
var k=[],n;for(n in d.properties){a=void 0!==d.properties[n]?d.properties[n]:" ";"object"==typeof a&&(a=JSON.stringify(a));var p=d.getPropertyInfo(n);if("enum"==p.type||"combo"==p.type)a=h.getPropertyPrintableValue(a,p.values);a=h.decodeHTML(a);k.push({content:"<span class='property_name'>"+(p.label?p.label:n)+"</span><span class='property_value'>"+a+"</span>",value:n})}if(k.length)return new f.ContextMenu(k,{event:c,callback:function(a,b,c,e){d&&(b=this.getBoundingClientRect(),g.showEditPropertyValue(d,
a.value,{position:[b.left,b.top]}))},parentMenu:e,allow_html:!0,node:d},b),!1}};h.decodeHTML=function(a){var b=document.createElement("div");b.innerText=a;return b.innerHTML};h.onMenuResizeNode=function(a,b,c,e,d){if(d){a=function(a){a.size=a.computeSize();if(a.onResize)a.onResize(a.size)};b=h.active_canvas;if(!b.selected_nodes||1>=Object.keys(b.selected_nodes).length)a(d);else for(var g in b.selected_nodes)a(b.selected_nodes[g]);d.setDirtyCanvas(!0,!0)}};h.prototype.showLinkMenu=function(a,b){var c=
this,e=c.graph.getNodeById(a.origin_id),d=c.graph.getNodeById(a.target_id),g=!1;e&&e.outputs&&e.outputs[a.origin_slot]&&(g=e.outputs[a.origin_slot].type);var k=!1;d&&d.outputs&&d.outputs[a.target_slot]&&(k=d.inputs[a.target_slot].type);var n=new f.ContextMenu(["Add Node",null,"Delete",null],{event:b,title:null!=a.data?a.data.constructor.name:null,callback:function(b,r,f){switch(b){case "Add Node":h.onMenuAdd(null,null,f,n,function(b){b.inputs&&b.inputs.length&&b.outputs&&b.outputs.length&&e.connectByType(a.origin_slot,
b,g)&&(b.connectByType(a.target_slot,d,k),b.pos[0]-=.5*b.size[0])});break;case "Delete":c.graph.removeLink(a.id)}}});return!1};h.prototype.createDefaultNodeForSlot=function(a){a=a||{};a=Object.assign({nodeFrom:null,slotFrom:null,nodeTo:null,slotTo:null,position:[],nodeType:null,posAdd:[0,0],posSizeFix:[0,0]},a);var b=a.nodeFrom&&null!==a.slotFrom,c=!b&&a.nodeTo&&null!==a.slotTo;if(!b&&!c)return console.warn("No data passed to createDefaultNodeForSlot "+a.nodeFrom+" "+a.slotFrom+" "+a.nodeTo+" "+a.slotTo),
...
t&&(t.classList.add("selected"),t.scrollIntoView({block:"end",behavior:"smooth"}))}function d(){function a(a,b){var d=document.createElement("div");m||(m=a);d.innerText=a;d.dataset.type=escape(a);d.className="litegraph lite-search-item";b&&(d.className+=" "+b);d.addEventListener("click",function(a){c(unescape(this.dataset.type))});v.appendChild(d)}w=null;var d=A.value;m=null;v.innerHTML="";if(d||b.show_all_if_empty)if(g.onSearchBox){var e=g.onSearchBox(v,d,k);if(e)for(var r=0;r<e.length;++r)a(e[r])}else{e=
...
!1,outTypeOverride:q&&q.value?"*":!1})&&filtered_extra.push(r);for(r=0;r<filtered_extra.length&&!(a(filtered_extra[r],"generic_type"),-1!==h.search_limit&&n++>h.search_limit);r++);}if((y.value||q.value)&&0==v.childNodes.length&&b.show_general_if_none_on_typefilter){filtered_extra=[];for(r in f.registered_node_types)e(r,{skipFilter:!0})&&filtered_extra.push(r);for(r=0;r<filtered_extra.length&&!(a(filtered_extra[r],"not_in_filter"),-1!==h.search_limit&&n++>h.search_limit);r++);}}}b=Object.assign({slot_from:null,
node_from:null,node_to:null,do_type_filter:f.search_filter_enabled,type_filter_in:!1,type_filter_out:!1,show_general_if_none_on_typefilter:!0,show_general_after_typefiltered:!0,hide_on_mouse_leave:f.search_hide_on_mouse_leave,show_all_if_empty:!0,show_all_on_open:f.search_show_all_on_open},b||{});var g=this,k=h.active_canvas,n=k.canvas,p=n.ownerDocument||document,r=document.createElement("div");r.className="litegraph litesearchbox graphdialog rounded";r.innerHTML="<span class='name'>Search</span> <input autofocus type='text' class='value rounded'/>";
...
function(){d()})}if(q){x=f.slot_types_out;H=x.length;if(b.type_filter_out==f.EVENT||b.type_filter_out==f.ACTION)b.type_filter_out="_event_";for(B=0;B<H;B++)C=document.createElement("option"),C.value=x[B],C.innerHTML=x[B],q.appendChild(C),!1!==b.type_filter_out&&(b.type_filter_out+"").toLowerCase()==(x[B]+"").toLowerCase()&&(C.selected=!0);q.addEventListener("change",function(){d()})}}u=n.getBoundingClientRect();q=(a?a.clientY:u.top+.5*u.height)-20;r.style.left=(a?a.clientX:u.left+.5*u.width)-80+"px";
r.style.top=q+"px";a.layerY>u.height-200&&(v.style.maxHeight=u.height-a.layerY-20+"px");A.focus();b.show_all_on_open&&d();return r};h.prototype.showEditPropertyValue=function(a,b,c){function e(){d(q.value)}function d(d){g&&g.values&&g.values.constructor===Object&&void 0!=g.values[d]&&(d=g.values[d]);"number"==typeof a.properties[b]&&(d=Number(d));if("array"==k||"object"==k)d=JSON.parse(d);a.properties[b]=d;a.graph&&a.graph._version++;if(a.onPropertyChanged)a.onPropertyChanged(b,d);if(c.onclose)c.onclose();
u.close();a.setDirtyCanvas(!0,!0)}if(a&&void 0!==a.properties[b]){c=c||{};var g=a.getPropertyInfo(b),k=g.type,f="";if("string"==k||"number"==k||"array"==k||"object"==k)f="<input autofocus type='text' class='value'/>";else if("enum"!=k&&"combo"!=k||!g.values)if("boolean"==k||"toggle"==k)f="<input autofocus type='checkbox' class='value' "+(a.properties[b]?"checked":"")+"/>";else{console.warn("unknown type: "+k);return}else{f="<select autofocus type='text' class='value'>";for(var h in g.values){var r=
h;g.values.constructor===Array&&(r=g.values[h]);f+="<option value='"+r+"' "+(r==a.properties[b]?"selected":"")+">"+g.values[h]+"</option>"}f+="</select>"}var u=this.createDialog("<span class='name'>"+(g.label?g.label:b)+"</span>"+f+"<button>OK</button>",c),q=!1;if("enum"!=k&&"combo"!=k||!g.values)if("boolean"==k||"toggle"==k)(q=u.querySelector("input"))&&q.addEventListener("click",function(a){u.modified();d(!!q.checked)});else{if(q=u.querySelector("input"))q.addEventListener("blur",function(a){this.focus()}),
r=void 0!==a.properties[b]?a.properties[b]:"","string"!==k&&(r=JSON.stringify(r)),q.value=r,q.addEventListener("keydown",function(a){if(27==a.keyCode)u.close();else if(13==a.keyCode)e();else if(13!=a.keyCode){u.modified();return}a.preventDefault();a.stopPropagation()})}else q=u.querySelector("select"),q.addEventListener("change",function(a){u.modified();d(a.target.value)});q&&q.focus();u.querySelector("button").addEventListener("click",e);return u}};h.prototype.createDialog=function(a,b){b=Object.assign({checkForInput:!1,
...
e.addSeparator=function(){var a=document.createElement("div");a.className="separator";e.content.appendChild(a)};e.addWidget=function(a,b,k,n,p){function d(a,b){n.callback&&n.callback(a,b,n);p&&p(a,b,n)}n=n||{};var g=String(k);a=a.toLowerCase();"number"==a&&(g=k.toFixed(3));var q=document.createElement("div");q.className="property";q.innerHTML="<span class='property_name'></span><span class='property_value'></span>";q.querySelector(".property_name").innerText=n.label||b;var y=q.querySelector(".property_value");
y.innerText=g;q.dataset.property=b;q.dataset.type=n.type||a;q.options=n;q.value=k;if("code"==a)q.addEventListener("click",function(a){e.inner_showCodePad(this.dataset.property)});else if("boolean"==a)q.classList.add("boolean"),k&&q.classList.add("bool-on"),q.addEventListener("click",function(){var a=this.dataset.property;this.value=!this.value;this.classList.toggle("bool-on");this.querySelector(".property_value").innerText=this.value?"true":"false";d(a,this.value)});else if("string"==a||"number"==
...
else if("Rename Slot"==b.content){b=b.slot;var g=b.input?a.getInputInfo(b.slot):a.getOutputInfo(b.slot),f=c.createDialog("<span class='name'>Name</span><input autofocus type='text'/><button>OK</button>",d),r=f.querySelector("input");r&&g&&(r.value=g.label||"");var k=function(){a.graph.beforeChange();r.value&&(g&&(g.label=r.value),c.setDirty(!0));f.close();a.graph.afterChange()};f.querySelector("button").addEventListener("click",k);r.addEventListener("keydown",function(a){f.is_modified=!0;if(27==a.keyCode)f.close();
...
1:Math.clamp(d,0,1),b[1]=1-Math.clamp(g,0,1),c.sort(function(a,b){return a[0]-b[0]}),this.selected=c.indexOf(b),this.must_update=!0)}}}};I.prototype.onMouseUp=function(a,b){this.selected=-1;return!1};I.prototype.getCloserPoint=function(a,b){var c=this.points;if(!c)return-1;b=b||30;for(var e=this.size[0]-2*this.margin,d=this.size[1]-2*this.margin,g=c.length,f=[0,0],h=1E6,l=-1,r=0;r<g;++r){var u=c[r];f[0]=u[0]*e;f[1]=(1-u[1])*d;u=vec2.distance(a,f);u>h||u>b||(l=r,h=u)}return l};f.CurveEditor=I;f.getParameterNames=
...
(this._last_v||0).toFixed(3)};A.prototype.onGetInputs=function(){return[["min","number"],["max","number"]]};q.registerNodeType("math/rand",A);h.title="Noise";h.desc="Random number with temporal continuity";h.data=null;h.getValue=function(a,b){if(!h.data){h.data=new Float32Array(1024);for(var c=0;c<h.data.length;++c)h.data[c]=Math.random()}a%=1024;0>a&&(a+=1024);var d=Math.floor(a);a-=d;c=h.data[d];d=h.data[1023==d?0:d+1];b&&(a=a*a*a*(a*(6*a-15)+10));return c*(1-a)+d*a};h.prototype.onExecute=function(){var a=
this.getInputData(0)||0,b=this.properties.octaves||1,c=0,d=1;a+=this.properties.seed||0;for(var e=this.properties.speed||1,f=0,g=0;g<b&&!(c+=h.getValue(a*(1+g)*e,this.properties.smooth)*d,f+=d,d*=this.properties.persistence,.001>d);++g);a=this.properties.min;this._last_v=c/f*(this.properties.max-a)+a;this.setOutputData(0,this._last_v)};h.prototype.onDrawBackground=function(a){this.outputs[0].label=(this._last_v||0).toFixed(3)};q.registerNodeType("math/noise",h);E.title="Spikes";E.desc="spike every random time";
...
this.setOutputData(0,this.values[h])};D.registerNodeType("logic/sequence",t);l.title="AND";l.desc="Return true if all inputs are true";l.prototype.onExecute=function(){ret=!0;for(inX in this.inputs)if(!this.getInputData(inX)){ret=!1;break}this.setOutputData(0,ret)};l.prototype.onGetInputs=function(){return[["and","boolean"]]};D.registerNodeType("logic/AND",l);w.title="OR";w.desc="Return true if at least one input is true";w.prototype.onExecute=function(){ret=!1;for(inX in this.inputs)if(this.getInputData(inX)){ret=
...
!1;break}this.setOutputData(0,ret)};h.prototype.onGetInputs=function(){return[["bool","boolean"]]};D.registerNodeType("logic/CompareBool",h);E.title="Branch";E.desc="Branch execution on condition";E.prototype.onExecute=function(h,l){this.getInputData(1)?this.triggerSlot(0):this.triggerSlot(1)};D.registerNodeType("logic/IF",E)})(this);
