...
var n=new f.ContextMenu(["Add Node",null,"Delete",null],{event:b,title:null!=a.data?a.data.constructor.name:null,callback:function(b,r,f){switch(b){case "Add Node":h.onMenuAdd(null,null,f,n,function(b){b.inputs&&b.inputs.length&&b.outputs&&b.outputs.length&&e.connectByType(a.origin_slot,b,g)&&(b.connectByType(a.target_slot,d,k),b.pos[0]-=.5*b.size[0])});break;case "Delete":c.graph.removeLink(a.id)}}});return!1};h.prototype.createDefaultNodeForSlot=function(a){a=a||{};a=Object.assign({nodeFrom:null,
...
b){var d=document.createElement("div");m||(m=a);d.innerText=a;d.dataset.type=escape(a);d.className="litegraph lite-search-item";b&&(d.className+=" "+b);d.addEventListener("click",function(a){c(unescape(this.dataset.type))});v.appendChild(d)}w=null;var d=A.value;m=null;v.innerHTML="";if(d||b.show_all_if_empty)if(g.onSearchBox){var e=g.onSearchBox(v,d,k);if(e)for(var r=0;r<e.length;++r)a(e[r])}else{e=function(a,c){c=c||{};c=Object.assign({skipFilter:!1,inTypeOverride:!1,outTypeOverride:!1},c);var e=
...
n++>h.search_limit);r++);}if((y.value||q.value)&&0==v.childNodes.length&&b.show_general_if_none_on_typefilter){filtered_extra=[];for(r in f.registered_node_types)e(r,{skipFilter:!0})&&filtered_extra.push(r);for(r=0;r<filtered_extra.length&&!(a(filtered_extra[r],"not_in_filter"),-1!==h.search_limit&&n++>h.search_limit);r++);}}}b=Object.assign({slot_from:null,node_from:null,node_to:null,do_type_filter:f.search_filter_enabled,type_filter_in:!1,type_filter_out:!1,show_general_if_none_on_typefilter:!0,
...
r.innerHTML+="<select class='slot_out_type_filter'><option value=''></option></select>");r.innerHTML+="<div class='helper'></div>";p.fullscreenElement?p.fullscreenElement.appendChild(r):(p.body.appendChild(r),p.body.style.overflow="hidden");if(b.do_type_filter)var u=r.querySelector(".slot_in_type_filter"),q=r.querySelector(".slot_out_type_filter");r.close=function(){g.search_box=null;this.blur();n.focus();p.body.style.overflow="";setTimeout(function(){g.canvas.focus()},20);r.parentNode&&r.parentNode.removeChild(r)};
...
this.setOutputData(0,this.values[h])};D.registerNodeType("logic/sequence",t);l.title="AND";l.desc="Return true if all inputs are true";l.prototype.onExecute=function(){var h=!0;for(inX in this.inputs)if(!this.getInputData(inX)){h=!1;break}this.setOutputData(0,h)};l.prototype.onGetInputs=function(){return[["and","boolean"]]};D.registerNodeType("logic/AND",l);w.title="OR";w.desc="Return true if at least one input is true";w.prototype.onExecute=function(){var h=!1;for(inX in this.inputs)if(this.getInputData(inX)){h=
!0;break}this.setOutputData(0,h)};w.prototype.onGetInputs=function(){return[["or","boolean"]]};D.registerNodeType("logic/OR",w);A.title="NOT";A.desc="Return the logical negation";A.prototype.onExecute=function(){var h=!this.getInputData(0);this.setOutputData(0,h)};D.registerNodeType("logic/NOT",A);h.title="bool == bool";h.desc="Compare for logical equality";h.prototype.onExecute=function(){var h=null,l=!0;for(inX in this.inputs)if(null===h)h=this.getInputData(inX);else if(h!=this.getInputData(inX)){l=
