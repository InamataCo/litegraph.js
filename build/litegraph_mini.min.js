...
a||100;for(var c=this.computeExecutionOrder(!1,!0),d=[],e=0;e<c.length;++e){var g=c[e],h=g._level||1;d[h]||(d[h]=[]);d[h].push(g)}c=a;for(e=0;e<d.length;++e)if(g=d[e]){h=100;for(var n=a+f.NODE_TITLE_HEIGHT,p=0;p<g.length;++p){var r=g[p];r.pos[0]=b==f.VERTICAL_LAYOUT?n:c;r.pos[1]=b==f.VERTICAL_LAYOUT?c:n;var u=b==f.VERTICAL_LAYOUT?1:0;r.size[u]>h&&(h=r.size[u]);n+=r.size[b==f.VERTICAL_LAYOUT?0:1]+a+f.NODE_TITLE_HEIGHT}c+=h+a}this.setDirtyCanvas(!0,!0)};m.prototype.getTime=function(){return this.globaltime};
...
n,this);this.processNodeDblClicked(g);u=!0}g.onMouseDown&&g.onMouseDown(a,n,this)?u=!0:(g.subgraph&&!g.skip_subgraph_button&&!g.flags.collapsed&&n[0]>g.size[0]-f.NODE_TITLE_HEIGHT&&0>n[1]&&(c=this,setTimeout(function(){c.openSubgraph(g.subgraph)},10)),this.live_mode&&(u=h=!0));u?g.is_selected||this.processNodeSelected(g,a):(this.allow_dragnodes&&(this.graph.beforeChange(),this.node_dragged=g),this.processNodeSelected(g,a));this.dirty_canvas=!0}}else if(!d){if(!this.read_only)for(u=0;u<this.visible_links.length;++u)if(h=
...
d.color||"#335";b.strokeStyle=d.color||"#335";var e=d._pos,g=d._size;b.globalAlpha=.25*this.editor_alpha;b.beginPath();b.rect(e[0]+.5,e[1]+.5,g[0],g[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(e[0]+g[0],e[1]+g[1]);b.lineTo(e[0]+g[0]-10,e[1]+g[1]);b.lineTo(e[0]+g[0],e[1]+g[1]-10);b.fill();g=d.font_size||f.DEFAULT_GROUP_FONT_SIZE;b.font=g+"px Arial";b.textAlign="left";b.fillText(d.title,e[0]+4,e[1]+g)}}b.restore()}};k.prototype.adjustNodesSize=function(){for(var a=
...
!0);e.graph.afterChange()}else{a=[];for(var r in c)a.push({content:r,value:c[r]});new f.ContextMenu(a,{event:b,callback:g,parentMenu:d,node:e});return!1}}if(e){var h=this;a=k.active_canvas.getCanvasWindow();b=e.optional_outputs;e.onGetOutputs&&(b=e.onGetOutputs());var n=[];if(b)for(var p=0;p<b.length;p++){var r=b[p];if(!r)n.push(null);else if(!e.flags||!e.flags.skip_repeated_outputs||-1==e.findOutputSlot(r[0])){var u=r[0];r[2]||(r[2]={});r[2].label&&(u=r[2].label);r[2].removable=!0;u={content:u,value:r};
r[1]==f.EVENT&&(u.className="event");n.push(u)}}this.onMenuNodeOutputs&&(n=this.onMenuNodeOutputs(n));f.do_add_triggers_slots&&-1==e.findOutputSlot("onExecuted")&&n.push({content:"On Executed",value:["onExecuted",f.EVENT,{nameLocked:!0}],className:"event"});e.onMenuNodeOutputs&&(b=e.onMenuNodeOutputs(n))&&(n=b);if(n.length)return new f.ContextMenu(n,{event:c,callback:g,parentMenu:d,node:e},a),!1}};k.onShowMenuNodeProperties=function(a,b,c,d,e){if(e&&e.properties){var g=k.active_canvas;b=g.getCanvasWindow();
var h=[],n;for(n in e.properties){a=void 0!==e.properties[n]?e.properties[n]:" ";"object"==typeof a&&(a=JSON.stringify(a));var p=e.getPropertyInfo(n);if("enum"==p.type||"combo"==p.type)a=k.getPropertyPrintableValue(a,p.values);a=k.decodeHTML(a);h.push({content:"<span class='property_name'>"+(p.label?p.label:n)+"</span><span class='property_value'>"+a+"</span>",value:n})}if(h.length)return new f.ContextMenu(h,{event:c,callback:function(a,b,c,d){e&&(b=this.getBoundingClientRect(),g.showEditPropertyValue(e,
a.value,{position:[b.left,b.top]}))},parentMenu:d,allow_html:!0,node:e},b),!1}};k.decodeHTML=function(a){var b=document.createElement("div");b.innerText=a;return b.innerHTML};k.onMenuResizeNode=function(a,b,c,d,e){if(e){a=function(a){a.size=a.computeSize();if(a.onResize)a.onResize(a.size)};b=k.active_canvas;if(!b.selected_nodes||1>=Object.keys(b.selected_nodes).length)a(e);else for(var g in b.selected_nodes)a(b.selected_nodes[g]);e.setDirtyCanvas(!0,!0)}};k.prototype.showLinkMenu=function(a,b){var c=
this,d=c.graph.getNodeById(a.origin_id),e=c.graph.getNodeById(a.target_id),g=!1;d&&d.outputs&&d.outputs[a.origin_slot]&&(g=d.outputs[a.origin_slot].type);var h=!1;e&&e.outputs&&e.outputs[a.target_slot]&&(h=e.inputs[a.target_slot].type);var n=new f.ContextMenu(["Add Node",null,"Delete",null],{event:b,title:null!=a.data?a.data.constructor.name:null,callback:function(b,r,f){switch(b){case "Add Node":k.onMenuAdd(null,null,f,n,function(b){b.inputs&&b.inputs.length&&b.outputs&&b.outputs.length&&d.connectByType(a.origin_slot,
b,g)&&(b.connectByType(a.target_slot,e,h),b.pos[0]-=.5*b.size[0])});break;case "Delete":c.graph.removeLink(a.id)}}});return!1};k.prototype.createDefaultNodeForSlot=function(a){a=a||{};a=Object.assign({nodeFrom:null,slotFrom:null,nodeTo:null,slotTo:null,position:[],nodeType:null,posAdd:[0,0],posSizeFix:[0,0]},a);var b=a.nodeFrom&&null!==a.slotFrom,c=!b&&a.nodeTo&&null!==a.slotTo;if(!b&&!c)return console.warn("No data passed to createDefaultNodeForSlot "+a.nodeFrom+" "+a.slotFrom+" "+a.nodeTo+" "+a.slotTo),
